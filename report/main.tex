...
\begin{enumerate}
    ...
    \item \textbf{Mrežna topologija (Mesh)} -- V omrežju z mesh topologijo je vsaka naprava neposredno povezana z vsemi ostalimi napravami. Med posameznimi vozlišči obstajajo ločene in neodvisne komunikacijske povezave, po katerih se prenašajo podatki. Zaradi takšne zasnove omrežje ne temelji na enem osrednjem vozlišču, temveč je popolnoma decentralizirano.
    ...
    \subsubsection*{Slabosti}
    \begin{itemize}
        \item Kompleksna izdelava in vzdrževanje: vsaka naprava je povezana z vsako (alternativa: delno mrežasta topologija)
        \item Visoka cena
    ...
    \subsubsection*{Prednosti}
    \begin{itemize}
        \item Naenkrat lahko prenaša le eno vozlišče, kar zmanjšuje trke paketov (packet collision)
        \item Implementacija je pogosto preprosta; kompleksnost dodajanja več vozlišč se linearno skalira, za razliko od kvadratnega skaliranja mrežaste (mesh) topologije
    \end{itemize}
